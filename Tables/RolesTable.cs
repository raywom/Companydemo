...
namespace CompanyDemo.Tables
{
    ...
    {
        private IRolesTable<TRole, TKey, TRoleClaim> _rolesTableImplementation;
        ...
        public virtual Task<IEnumerable<TRole>> GetAllRolesAsync() {
            const string sql = "SELECT * FROM [dbo].[AspNetRoles]";
            return DbConnection.QueryAsync<TRole>(sql);
        }
